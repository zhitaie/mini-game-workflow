...
import { fetchAnalyticsEvents } from '../services/admin-web/dist/services/admin-web/src/services/analytics.js';
import { fetchConfigs } from '../services/admin-web/dist/services/admin-web/src/services/configs.js';
import { fetchDashboardSummary } from '../services/admin-web/dist/services/admin-web/src/services/dashboard.js';
import { fetchNotices } from '../services/admin-web/dist/services/admin-web/src/services/notices.js';
